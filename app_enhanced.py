...
# ============================================
# STEP 2: Chief Complaint (with Multi-Selection)
# ============================================
    ...
    for i, (label, value) in enumerate(respiratory_symptoms.items()):
        col = [col1, col2, col3][i % 3]
        with col:
            if st.checkbox(label, key=f"resp_{i}"):
                selected_symptoms.append(value)
    ...
    for i, (label, value) in enumerate(gi_symptoms.items()):
        col = [col1, col2, col3][i % 3]
        with col:
            if st.checkbox(label, key=f"gi_{i}"):
                selected_symptoms.append(value)
    ...
    for i, (label, value) in enumerate(neuro_symptoms.items()):
        col = [col1, col2, col3][i % 3]
        with col:
...
# ============================================
    ...
    # Pre-select symptoms already chosen
    existing_symptoms = st.session_state.patient_data.get('symptoms', [])
    default_index = [symptom_options.index(s) for s in existing_symptoms if s in symptom_options]
